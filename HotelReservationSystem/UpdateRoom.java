...
public class UpdateRoom extends JFrame {
    ...
    public UpdateRoom() throws SQLException {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HotelReversationSystem/Ions/room2.jpg"));
        Image i3 = i1.getImage().getScaledInstance(750, 700,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l1 = new JLabel(i2);
        l1.setBounds(400,0,700,500);
        add(l1);
