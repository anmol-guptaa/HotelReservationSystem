...
public class AddEmployee extends JFrame {
    JTextField textField, textField_1, textField_3, textField_4, textField_5, textField_6, textField_7;
    JComboBox c1;
    ...
    public AddEmployee() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("HotelReversationSystem/Ions/employee.jpg"));
        ...
        Next.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "INSERT INTO employee values('" + name + "', '" + age + "', '" + gender + "', '" + job + "', '" + salary + "', '" + phone + "', '" + aadhar + "', '" + email + "', '" + ID + "')";
