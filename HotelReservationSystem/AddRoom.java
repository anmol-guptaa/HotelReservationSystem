...
public class AddRoom extends JFrame implements ActionListener{
    ...
    public AddRoom() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HotelReversationSystem/Ions/room3.jpg"));
        Image i3 = i1.getImage().getScaledInstance(700, 600,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l15 = new JLabel(i2);
        l15.setBounds(400,0,700,470);
        add(l15);
